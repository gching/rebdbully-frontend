...
firepad.Firepad = (function(global) {
  ...
  */
  Firepad.prototype.makeHeaderDialog_ = function(timestamp){
    this.makeDialog_('header-timestamp', 'Insert text for the header', timestamp);
  }

  Firepad.prototype.makeDialog_ = function(id, placeholder, timestamp) {
   var self = this;
   ...
   var cb = function() {
     ...
     if (timestamp){
       ...
       // TODO - Set timestamp
       self.insertEntity(id, {timestamp: timestamp, textContent: src})
     } else if (src !== null){
